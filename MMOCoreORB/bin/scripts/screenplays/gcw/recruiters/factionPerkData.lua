...
rebelRewardData = {
	weaponsArmorList = {
		...
		"armor_marine_bicep_r", "carbine_laser", "pistol_scout_blaster", "lance_staff_metal", "rocket_launcher", "mine_drx", "mine_xg", "reb_cape", "reb_barc"
	},
	...
	weaponsArmor = {
		...
		reb_barc = { type=factionRewardType.weapon, display="@pet_deed:barc_speeder_rebel", item="object/tangible/deed/vehicle_deed/barc_speeder_rebel_deed.iff", cost=12500},
	},
...
imperialRewardData = {
	weaponsArmorList = {
		...
		"rocket_launcher", "mine_drx", "mine_xg", "imp_barc"
	},
	...
	weaponsArmor = {
		...
		mine_drx = { type=factionRewardType.weapon, display="@weapon_name:mine_drx", item="object/weapon/mine/wp_mine_drx55.iff", cost=350},
		mine_xg = { type=factionRewardType.weapon, display="@weapon_name:mine_xg", item="object/weapon/mine/wp_mine_xg.iff", cost=350},
		imp_barc = { type=factionRewardType.weapon, display="@pet_deed:barc_speeder_imperial", item="object/tangible/deed/vehicle_deed/barc_speeder_imperial_deed.iff", cost=12500},
	},
