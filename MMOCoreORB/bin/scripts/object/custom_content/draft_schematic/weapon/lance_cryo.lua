...
object_draft_schematic_weapon_lance_cryo = object_draft_schematic_weapon_shared_lance_cryo:new {
   ...
   ingredientTitleNames = {"lance_shaft", "vibration_generator", "grip"},
   ingredientSlotType = {0, 1, 0},
   resourceTypes = {"steel_ditanium", "object/tangible/component/weapon/shared_vibro_unit.iff", "metal_nonferrous"},
   resourceQuantities = {55, 4, 15},
